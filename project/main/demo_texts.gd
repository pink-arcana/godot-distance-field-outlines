...
const EffectDisplayNames := {
	...
	DFOutlineSettings.EffectID.INVERTED : "Inverted",
	DFOutlineSettings.EffectID.SKETCH : "Sketch",
	DFOutlineSettings.EffectID.NEON_GLOW : "Neon Glow",
	DFOutlineSettings.EffectID.RAINBOW_ANIMATION : "Rainbow Animation",
}
